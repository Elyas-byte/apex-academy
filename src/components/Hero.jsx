...
export default function Hero() {
  return (
    <section
      id="home"
      className="bg-[linear-gradient(to_bottom,rgba(0,0,0,0.6),rgba(0,0,0,0.6)),url('sample-hero.jpg')] scroll-mt-20 bg-cover bg-center h-screen flex items-center justify-center text-white"
    >
